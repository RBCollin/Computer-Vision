...
def detect(opt):
    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        #### TRACK_3 TEM QUE ATUALIZAR BEEEM PROXIMO DE TRACK 2. POREM ANTES.
        ...
        if time_passed > 70:
            ...
            if count > 1000 and count < 1800:
                ...
                frutos_passados = df_sql_count['frutos_contados_3'][0]
                frutos_passados = int(frutos_passados)

                # tons_tot 
                # percent_passed 

                percent_passed = df_sql_count['percent_passed_3'][0]
                tons_passed = df_sql_count['tons_passed_3'][0]


                #### VARIAVEIS CONTAGEM 2
                frutos_contados_2 = df_sql_count['frutos_contados'][0]
                frutos_passados_atual_2 = df_sql_count['frutos_passados_atual'][0]
                tons_tot_2 = df_sql_count['tons_tot'][0]
                percent_passed_2 = df_sql_count['percent_passed'][0]
                tons_passed_2 = df_sql_count['tons_passed'][0]
                ...
                count_atualizado__22inicio =  int(frutos_passados + count_fly2)
                ...
                VALUES (0, {frutos_contados_2},{frutos_passados_atual_2},{tons_tot_2},{percent_passed_2},{tons_passed_2},
                {count_atualizado__22inicio},{count_fly2}, {tons_tot} ,{percent_passed}, {frutos_passados})
                """)
            ...
            if count > 1800:
                ...
                frutos_totais = df_sql_count['frutos_contados_3'][0]
                quantidade_primeira_interacao = df_sql_count['frutos_passados_atual_3'][0]
                ...
                count_atualizado =  frutos_totais + frutos_passados
                ...
                frutos_contados_3, frutos_passados_atual_3, tons_tot_3, percent_passed_3, tons_passed_3)
                VALUES (0, {frutos_contados_2},{frutos_passados_atual_2},{tons_tot_2},{percent_passed_2},{tons_passed_2},
                 {count_atualizado},{frutos_passados}, {tons_tot}, {percent_passed}, {frutos_passados})
                """)
            ...
            df_sql_count = pd.read_sql_query("""SELECT * FROM frutos_count """, conn)
            count_atualizado = df_sql_count['frutos_contados_3'][0]
            ...
            frutos_contados_3, frutos_passados_atual_3, tons_tot_3, percent_passed_3, tons_passed_3)
            VALUES (0,{frutos_contados_2},{frutos_passados_atual_2},{tons_tot_2},{percent_passed_2},{tons_passed_2} 
            ,{count_atualizado},{count_fly2}, {tons_tot}, {percent_passed}, {frutos_passados})
            """)
            ...
            if controle_MAF != controle_maf_inicial:
                    ...
                    INSERT INTO frutos_count (Controle,frutos_contados, frutos_passados_atual, tons_tot, percent_passed, tons_passed ,
                    frutos_contados_3, frutos_passados_atual_3, tons_tot_3, percent_passed_3, tons_passed_3)
                    VALUES ({controle_reset}, {frutos_contados_2},{frutos_passados_atual_2},{tons_tot_2},{percent_passed_2},{tons_passed_2}
                    ,{frutos_reset},{cont_reset}, {tons_tot_reset}, {percent_passed},{tons_passed})
                    """)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='rtsp://admin:admin102030@192.168.3.96:554/cam/realmonitor?channel=1&subtype=1', help='source') 
    ...
    ## TODA VEZ QUE REINICIAR O APP TENHO QUE CALIBRAR COM A WEBCAM ANTES E AI RODAR COM A LOCAL
...
import ultralytics
ultralytics.start('e8eddd9e02e5c3817bd4d02d984b26df0255ed5427_pivRLxI8AzmUNenHbMjJ')
